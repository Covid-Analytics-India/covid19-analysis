...
get_news("1f12c8db15274b15be45911d8fd84e60")
news_scheduler = BackgroundScheduler()
news_scheduler.add_job(func=lambda: get_news("1f12c8db15274b15be45911d8fd84e60"),  trigger='interval', seconds=60 * 15) # news update every 15 mins
...
if __name__ == "__main__":
    app.run(port=5000, debug=True, host='0.0.0.0')  # for deployment turn it off(False)
